...
//           unselectedLabelColor: colors.text.withValues(102),
//         ),
...
class AppTheme extends ThemeExtension<AppTheme> {
  ...
  ThemeData get themeData => ThemeData(
    ...
    // ✅ Updated to use TabBarThemeData with named parameters
    tabBarTheme: TabBarThemeData(
      labelColor: colors.text,
      unselectedLabelColor: colors.text.withValues(alpha: 102),
    ),
    filledButtonTheme: FilledButtonThemeData(
      style: styles.buttonLarge.copyWith(
        backgroundColor: WidgetStateProperty.resolveWith((states) {
    ...
    inputDecorationTheme: InputDecorationTheme(
      ...
      hintStyle: typographies.bodySmall.copyWith(
        fontWeight: FontWeight.w500,
        // ✅ Make sure alpha is an int
        color: colors.text.withValues(alpha: 102),
      ),
      border: OutlineInputBorder(
        borderRadius: BorderRadius.circular(100),
        borderSide: BorderSide.none,
